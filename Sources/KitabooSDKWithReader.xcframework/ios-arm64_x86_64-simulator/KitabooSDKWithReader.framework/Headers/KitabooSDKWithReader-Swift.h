...
@property (nonatomic, readonly, strong) HDVoiceRecognizeManager * _Nonnull voiceSeacrh;
...
@interface TextSearchView (SWIFT_EXTENSION(KitabooSDKWithReader)) <HDVoiceRecognizeManagerDelegate>
